...
import myEpicGame from '../src/utils/MyEpicGame.json';
...
const App = () => {
  ...
  const checkNetwork = async () => {
    try{
      ...
      if(netVersion !== '5'){
        alert('Goerli Test Networkに接続してください')
      }else{
        console.log('Goerliに接続されています')
      }
    }catch(error){
      console.log(error);
    }
